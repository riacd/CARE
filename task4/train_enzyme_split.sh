nohup python task4/CREEP/step_01_train_CREEP_task4.py \
    ...
    --train_file data/enzyme_split/train_pairs.tsv \
    --val_file data/enzyme_split/val_pairs.tsv \
    ...
    --output_model_dir task4/output/enzyme_split_run \
    --wandb_project care-task4-creep \
    --wandb_run_name creep-task4-enzyme_split \
    --wandb_mode offline \
    > enzyme_split_run_nohup.log 2>&1 &
