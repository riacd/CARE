...
class CREEPModel(nn.Module):
    ...
    def forward(
        self,
        protein_sequence_input_ids,
        protein_sequence_attention_mask,
        text_sequence_input_ids=None,
        text_sequence_attention_mask=None,
        reaction_sequence_input_ids=None,
        reaction_sequence_attention_mask=None,
    ):
        ...
        if text_sequence_input_ids is not None and text_sequence_attention_mask is not None:
